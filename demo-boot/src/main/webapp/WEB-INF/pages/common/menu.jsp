	...
	<div id="main-menu-inner">
		...
		<ul class="navigation">
			<li class="mm-dropdown" opCode="04">
		        <a href="#"><i class="menu-icon fa fa-cogs"></i><span class="mm-text">供应商管理</span></a>
		        <ul>
		            <li opCode="0401">
		                <a tabindex="-1" href="javascript:goPage('admin/suppmaster/mainPage')"><span class="mm-text">供应商信息</span></a>
		            </li>
		            <li opCode="0402">
		                <a tabindex="-1" href="javascript:goPage('admin/suppcontacts/mainPage')"><span class="mm-text">联系人信息</span></a>
		            </li>
		        </ul>
		    </li>
		    <li class="mm-dropdown" opCode="01">
		        <a href="#"><i class="menu-icon fa fa-cogs"></i><span class="mm-text">权限管理1</span></a>
		        <ul>
		            <li opCode="0101">
